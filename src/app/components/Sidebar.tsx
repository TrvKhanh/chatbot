        ...
        <div className="px-4 space-y-4">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/dashboard/analytics" className="flex items-center px-3 py-2 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
